# Generated by Django 4.1.1 on 2022-10-15 05:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('initialBid', models.DecimalField(decimal_places=4, max_digits=19)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('auctionListing', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='auctions.auctionlisting')),
